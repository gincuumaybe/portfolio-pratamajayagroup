...
@section('content')
    ...
    <section id="about-us">
        ...
        <div class="about-us-social">
            ...
            <a href="https://wa.me/6287823873079?text=Halo,%20saya%20ingin%20bertanya%20tentang%20layanan%20Anda"
                target="_blank" class="social-card wa">
                <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-whatsapp" viewBox="0 0 16 16">
                        <path
            ...
            <a href="https://instagram.com/pratama_jaya_group" target="_blank" class="social-card ig">
                <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-instagram" viewBox="0 0 16 16">
                        <path
            ...
            <a href="https://www.tiktok.com/@angkycuy" target="_blank" class="social-card tiktok">
                <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-tiktok" viewBox="0 0 16 16">
                        <path
